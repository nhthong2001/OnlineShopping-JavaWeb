...
<nav class="navbar navbar-expand-lg navbar-light bg-light sticky-top shadow mb-4">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <div class="navbar-nav mr-auto">
            <form class="form-inline my-2 my-lg-0" method="post" id="frmSearch">
                <input class="form-control mr-sm-2" type="search" placeholder="Aa" aria-label="Search" id="txtInfo" name="info">
                ...
                <c:when test="${auth}">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                            <a class="dropdown-item" href="${pageContext.request.contextPath}/account/profile">Hồ sơ cá
                                nhân</a>
